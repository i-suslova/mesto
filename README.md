...
:star: Работа по созданию инерактивного одностраничного сайта,

сделанная при прохождении обучения в [**_ЯндексПрактикум_**](https://practicum.yandex.ru/web/).

---
:star: на сайте реализована возможность редактировать профиль и аватар пользователя; добавлять новую карточку с фотографией, названием и описанием; удалить карточку, отметить понравившуюся карточку лайком
